...
import { Bell, Lock, User, Eye, Shield } from "lucide-react";
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                <div className="flex items-center gap-2">
                  ...
                  <Label htmlFor="twoFactor" className="font-medium">Two-Factor Authentication</Label>
                </div>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-muted-foreground">
                Receive transaction and activity updates via email
              </p>
            </div>
