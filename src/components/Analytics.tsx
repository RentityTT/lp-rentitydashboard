...
const Analytics = () => {
  ...
  const properties = [
    { name: "Century City", occupancy: 92, revenue: "$52,000", status: "High" },
    { name: "Juniper Tower", occupancy: 85, revenue: "$48,500", status: "Medium" },
    { name: "Atmosphere", occupancy: 78, revenue: "$24,000", status: "Medium" }
  ];
        ...
        <CardContent>
          <ResponsiveContainer width="100%" height={400}>
            <AreaChart data={revenueData}>
              ...
              <Area
                ...
                fill="url(#colorCenturyCity)"
                strokeWidth={2}
              />
              <Area
                type="monotone"
                dataKey="juniperTower"
                name="Juniper Tower"
                stroke="hsl(90, 70%, 60%)"
                fill="url(#colorJuniperTower)"
                strokeWidth={2}
              />
              <Area
                type="monotone"
          ...
          <div className="flex items-center justify-center gap-6 mt-4">
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 rounded-full" style={{ backgroundColor: "hsl(180, 65%, 45%)" }} />
              <span className="text-sm text-muted-foreground">Century City</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 rounded-full" style={{ backgroundColor: "hsl(90, 70%, 60%)" }} />
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              <CardTitle>Blockchain Payment History</CardTitle>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-2">
                      ...
                      <Button
                        ...
                        onClick={() => copyToClipboard(payment.wallet, "Wallet address")}
                      >
                  ...
                  <TableCell className="text-right">
                    <div className="flex items-center justify-end gap-2">
                      <Button
                        ...
                        onClick={() => copyToClipboard(payment.txHash, "Transaction hash")}
                      >
